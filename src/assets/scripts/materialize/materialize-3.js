...
;(function ($) {
  ...
  $(document).ready(function () {
    // Text based inputs
    var input_selector = 'input[type=text]:not(.mdc-text-field__input), input[type=password]:not(.mdc-text-field__input), input[type=email]:not(.mdc-text-field__input), input[type=url]:not(.mdc-text-field__input), input[type=tel]:not(.mdc-text-field__input), input[type=number]:not(.mdc-text-field__input), input[type=search]:not(.mdc-text-field__input), input[type=date]:not(.mdc-text-field__input), input[type=time]:not(.mdc-text-field__input), textarea:not(.mdc-text-field__input)';
...
// Importing Material Components for the Web
// Textfields
